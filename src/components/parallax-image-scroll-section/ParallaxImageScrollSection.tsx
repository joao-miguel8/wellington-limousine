	...
	return (
		<div className="mb-28 relative">
			...
			<div className="w-full absolute top-1/2 -translate-y-1/2 ">
				<h2 className="px-2 mx-auto mb-30 font-taviraj max-w-[600px] text-30 min-[400px]:text-38 sm:text-50 md:text-62 text-center text-white">Tavel in Quality and Comfort</h2>
			</div>
		</div>
	);
}
