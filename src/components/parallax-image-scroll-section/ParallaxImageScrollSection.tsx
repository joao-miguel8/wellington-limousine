function ParallaxImageScrollSection() {
	return (
		<div className="mb-28 relative">
			<div className={`h-[30rem] sm:h-[50rem] w-full object-fit bg-no-repeat bg-cover flex justify-center bg-center align-center bg-fixed brightness-50 bg-[url(../src/assets/client-in-backseat.jpg)]`}></div>
